...
// enter room with name and room name
...
// event listeners in classes with different forms
...
// activity to show if someone is typing
let activityTimer
    ...
    if (users) {
        ...
        users.forEach((user, i) => {
            ...
            if (users.length > 1 && i !== users.length - 1) {
                usersList.textContent += ","    // adding , between users
            }
        })
    }
}
